	  ...
	  <div class="main-card mb-3 card">
		...
		<div class="col-md-6">
			<div class="card mb-3 widget-content">
				<div class="card-body">
					<form method="POST" style="text-transform:uppercase" action="request-save.php?action=adds">
						<h6><i class="pe-7s-user"> </i> <?php echo $_SESSION['sessUsername'] ?></h6><br>
                        <h6><i class="pe-7s-phone"></i> +6 <?php echo $_SESSION['sessContact'] ?></h6><br>
						<h6><i class="pe-7s-mail"></i> <?php echo $_SESSION['sessEmail'] ?></h6><br>
						<h6><i class="pe-7s-date"></i><b> Required Date Before:</b><br><br><input type="date" name="del" style="width: 206px" value="2020-06-22" min="2020-09-01" max="2021-12-12" required></h6>
						</br>
						...
						<div class="row">
						<div class="col-lg-7" >
						<h6><b>Subtotal</b></h6><br>
						</div>                            
						<div align="right" class="col-lg-4">
						<b>RM <?php echo $_SESSION['mm']; ?></b></h6><br>
						</div> 
						<div class="col-lg-7">
						<h6><b>Total</b></h6><br>
						</div> 
						<div align="right" class="col-lg-4">
							<h6><b>RM<?php echo $_SESSION['mm']; ?></b> </h6><br>
						</div>                            
						</div>
						<center>
