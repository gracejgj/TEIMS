...
<div class="tab-content">
	<div class="main-card mb-3 card">
		...
		<form role="form" method="post" action="product-add1.php?action=add">
    <?php
          if (isset($_GET['required'])) {
            if ($_GET["required"]=="product") {
              echo '<p class="error-msg text-danger">Product name is required</p>';
               ...
               echo '<p class="error-msg text-danger">Product Code is already taken.</p>';
            }
            }      ?>
			...
			<tr>
				<td>Part Name</td>
				<td> <input type="textarea" name="partname" class="form-control" pattern ="[a-zA-Z0-9!@#$&()\\-`.+,/\" required /> </td>
			</tr>
			...
			<tr>
				<td> Rack</td>
				<td> <input type="text" name="rack" class="form-control" pattern="[A-Za-z0-9]+" title="No special characters are allow" required /> </td>
			</tr>
