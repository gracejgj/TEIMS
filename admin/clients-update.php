	...
	* content
	...
	<div class="tab-content">
		<div class="main-card mb-3 card">
			<div class="card-body">
				<h5 class="card-title">Updating CLients</h5>
				<form action="clients-update1.php?pid=<?php echo $p_id; ?>" method="post">	
					...
					<tr>
						<td> Username</td>
						<td> <input type="text" name="username" value="<?php echo $rows['username']; ?>" class="form-control" pattern="[A-Za-z0-9]+" maxlength="15" required /> </td>
					</tr>
					
					<tr>
						<td> Password</td>
						<td> <input type="text" name="password" value="<?php echo $rows['password']; ?>" class="form-control" pattern ="["^[a-zA-Z0-9!@#$&()\\-`.+,/\"]*$"]" maxlength="15" required /> </td>
					</tr>
