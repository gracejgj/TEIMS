    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
	 <?php include 'aa-header.php';?>
			...
			* content
			...
			<div class="card-body">
			<a button class="mb-2 mr-2 btn btn-light" align="right" href="inventory-add.php">Add Equipment</button></a>
			<tr>
			...
			<div class="card-body"><h5 class="card-title">Manage Spare Parts</h5>
			...
			<tbody>
			<?php
			$sql = "select * from particulars, rack WHERE particulars.rack_id=rack.rack_id ORDER BY part_id desc";
			...
			<td><?php echo $row_selectParticular['rack_name']; ?> </td>
